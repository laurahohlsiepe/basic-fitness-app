...
<template>
  <header>
      <div class="flex flex-wrap justify-center items-center mx-auto max-w-screen-xl">
         <h1 class="text-pink-400 text-2xl text-center mb-4">This the most basic Fitness App ever</h1>       
      </div>
  </header>
  <body class=" full-screen">

  <section class="flex flex-col md:flex-col sm:mx-16 lg:mx-20">
    <h2 class="text-2xl text-center py-6">Legday</h2>
  <div class="flex flex-col justify-center align-between">
    ...
    <div class="flex justify-center">
      <button class="text-white bg-pink-400 font-medium rounded-lg px-5 py-2.5 w-32 h-1/3 text-center" type="submit" @click="addWorkout()">send</button>    
    </div>
    ...
    <div class="overflow-x-auto mt-6">
      ...
      <tbody>
        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
          ...
          <td class="px-6 py-4">reps</td>
        </tr>
        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
          <th  scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">Squats</th>
          <td class="px-6 py-4">reps</td>
        </tr>
        <tr v-for="workout in workouts" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
          <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ workout.text }}</td>
          <td class="px-6 py-4">{{ selectedValue }}</td>
        </tr>
      </tbody>
    </table>   
    </div>
